...
This mechanism has been integrated into Bitcore-Node-B2C which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/B2C-Project/insight-api-blackbearcoin#web-socket-api](https://github.com/B2C-Project/insight-api-blackbearcoin#web-socket-api) 
* API: [https://github.com/B2C-Project/insight-api-blackbearcoin#swifttx-transactions](https://github.com/B2C-Project/insight-api-blackbearcoin#swifttx-transactions) 
...
By default, the Black Bear Coin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Black Bear Coin Core daemon:
