...
In order to support loading of multiple wallets in blackbearcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is blackbearcoin.cpp.
...
Changes to blackbearcoin.cpp
----------------------
blackbearcoin.cpp is the entry point into blackbearcoin-qt, and as such, will require some minor modifications to provide hooks for
