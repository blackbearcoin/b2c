...
ACLOCAL = ${SHELL} /prj/coinFactory/works/bitcoin/blackbearcoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /prj/coinFactory/works/bitcoin/blackbearcoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /prj/coinFactory/works/bitcoin/blackbearcoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /prj/coinFactory/works/bitcoin/blackbearcoin/build-aux/missing automake-1.15
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} /prj/coinFactory/works/bitcoin/blackbearcoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /prj/coinFactory/works/bitcoin/blackbearcoin
abs_srcdir = /prj/coinFactory/works/bitcoin/blackbearcoin
abs_top_builddir = /prj/coinFactory/works/bitcoin/blackbearcoin
abs_top_srcdir = /prj/coinFactory/works/bitcoin/blackbearcoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /prj/coinFactory/works/bitcoin/blackbearcoin/build-aux/install-sh
