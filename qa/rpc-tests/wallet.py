...
#   c) node1 mines 32 blocks, so now node 0 has 60001blackbearcoin, node 1 has 4250blackbearcoin, node2 has none.
#   d) node0 sends 601 blackbearcoin to node2, in two transactions (301 blackbearcoin, then 300 blackbearcoin).
