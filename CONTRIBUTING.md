Contributing to Black Bear Coin Core
============================

The Black Bear Coin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Black Bear Coin Core project, and is not to be
confused with overall B2C Network Protocol consensus changes.

Whether a pull request is merged into Black Bear Coin Core rests with the project merge
...
Patches that change B2C consensus rules are considerably more involved than
...
Where a patch set proposes to change the B2C consensus, it must have been
...
The project leader is the release manager for each Black Bear Coin Core release.
