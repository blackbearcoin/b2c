...
/** Utility functions used by the B2C Qt UI.
 */
namespace GUIUtil
{
...
// Render B2C addresses in monospace font
...
// Parse "blackbearcoin:" URI into recipient object, return true on successful parsing
