...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Black Bear Coin Core"),
     ...
     * override -datadir in the blackbearcoin.conf file in the default data directory
     * (to be consistent with blackbearcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
