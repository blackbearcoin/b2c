...
/* Black Bear Coin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "B2C"
#define QAPP_ORG_DOMAIN "blackbearcoin.org"
#define QAPP_APP_NAME_DEFAULT "BlackbearCoin-Core"
#define QAPP_APP_NAME_TESTNET "BlackbearCoin-Core-testnet"
