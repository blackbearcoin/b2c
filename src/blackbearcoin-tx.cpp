...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Black Bear Coin Core blackbearcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  blackbearcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded blackbearcoin transaction") + "\n" +
                               "  blackbearcoin-tx [options] -create [commands]   " + _("Create hex-encoded blackbearcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded blackbearcoin transaction
