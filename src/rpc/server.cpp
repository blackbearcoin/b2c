...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* B2C features */
        {"blackbearcoin", "masternode", &masternode, true, true, false},
        {"blackbearcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"blackbearcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"blackbearcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"blackbearcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"blackbearcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"blackbearcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"blackbearcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"blackbearcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"blackbearcoin", "startmasternode", &startmasternode, true, true, false},
        {"blackbearcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"blackbearcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"blackbearcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"blackbearcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"blackbearcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"blackbearcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"blackbearcoin", "mnsync", &mnsync, true, true, false},
        {"blackbearcoin", "spork", &spork, true, true, false},
        {"blackbearcoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> blackbearcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17791/\n";
}
