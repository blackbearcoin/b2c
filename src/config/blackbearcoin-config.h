/* src/config/blackbearcoin-config.h.  Generated from blackbearcoin-config.h.in by configure.  */
/* src/config/blackbearcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "blackbearcoin.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Black Bear Coin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Black Bear Coin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "blackbearcoin"
