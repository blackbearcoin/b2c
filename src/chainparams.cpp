...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000b8cfb7ea87096c87d90aa78c7002f0aebe6d803f47059cf4e3eae53bf91"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1615090601, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nEnforceNewSporkKey = 1615090601;
        nRejectOldSporkKey = 1615090601;
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1615090601;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 264988;

        hashGenesisBlock = genesis.GetHash();


        assert(hashGenesisBlock == uint256("0x00000b8cfb7ea87096c87d90aa78c7002f0aebe6d803f47059cf4e3eae53bf91"));
      ...
      vSeeds.push_back(CDNSSeedData("node5", "node5.blackbearcoin.com"));
        ...
        nStartMasternodePayments = 1615090601;
    }
