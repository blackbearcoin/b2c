...
/** 
    ...
    ****Note - for B2C we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of blackbearcoin coming in to a transaction
